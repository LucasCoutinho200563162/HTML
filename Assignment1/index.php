        ...
        <main>
            ...
            <form action="order_placed.php" method="get">
                ...
                <fieldset>
                    ...
                    <br>
                    <!-- Crust type-->
                    <label for="crusType">What crust?</label>
                    <select id="crusType" name="crusType">
                    ...
                    <fieldset>
                        ...
                        <input type="text" id="firstName" name="firstName" placeholder="e.g. John" class = "personal_text" required>
                        <label for="lasttName">Last Name:</label>
                        <input type="text" id="lasttName" name="lasttName" placeholder="e.g. Doe" class = "personal_text" required>
